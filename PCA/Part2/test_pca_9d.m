...
close all;
clc;
ml_toolbox_path = 'C:\Users\Subzero\Documents\MATLAB\ML_toolbox-master\';
...
% Project Data to Choosen Principal Components given a number of p
% eigenvectors
p = 9;
...
% Plot EigenValues in order to try to find the optimal "p"
plot_eigenvalues(L);
